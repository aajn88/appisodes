...
import com.movile.persistence.managers.api.ICrudManager;
...
public class CrudManager<Entity, Id> implements ICrudManager<Entity, Id> {
    ...
    public Entity findById(Id id) {
        ...
        try {
            ...
            Log.e(TAG_LOG, StringUtils
                    .format("An error ocurrs finding an element of the Entity {%s} with id {%s}",
                            clazz, id), e);
        }
    ...
    public Entity deleteById(Id id) {
        ...
        try {
            ...
            Log.e(TAG_LOG, StringUtils
                    .format("An error occurs while deleting an element of the entity {%s} with Id {%s}",
                            clazz, id), e);
        }
        return entity;
    }
