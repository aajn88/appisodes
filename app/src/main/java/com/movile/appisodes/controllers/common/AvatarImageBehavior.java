 ...
 */
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ShapeImageView> {
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalYPosition = a
                    .getDimension(R.styleable.AvatarImageBehavior_finalYPosition, 0);
            mCustomStartXPosition = a
                    .getDimension(R.styleable.AvatarImageBehavior_startXPosition, 0);
            mCustomStartToolbarPosition = a
                    .getDimension(R.styleable.AvatarImageBehavior_startToolbarPosition, 0);
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, ShapeImageView child,
                                   View dependency) {
        return dependency instanceof Toolbar;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, ShapeImageView child,
                                          View dependency) {
    ...
    private void maybeInitProperties(ShapeImageView child, View dependency) {
